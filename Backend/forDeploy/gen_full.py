...
encoders_trans = 'Backend/forDeploy/aux_files/chords_encoders_all.pickle'
...
val_temp_path = 'Backend/forDeploy/aux_files/Valence_Templates.pickle'
with open(val_temp_path, 'rb') as handle:
    val_templates = pickle.load(handle)
    
dense_temp_path = 'Backend/forDeploy/aux_files/Density_Templates.pickle'
